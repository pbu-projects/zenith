...
class ZenithSpec extends Specification {
    ...
    void 'test zendesk tools against live instance'() {
        ...
        def batchResp = zendeskTools.batchUpdateTickets([7L], "Batch concurrent update test", null, null, false, [uploadResp.upload.token], null, false, null, null, null, null)
        ...
        def asyncBulkResp = zendeskTools.batchUpdateTickets([7L], "Batch bulk async test", null, null, false, null, null, true, null, null, null, null)
